...
# ``first_cicd_project/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-first_cicd_project-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.first_cicd_project.first_cicd_project-model", label="Full (Three-Level) Model Name"
)
