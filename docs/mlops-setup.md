...
git add README.md docs .gitignore first_cicd_project/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[first_cicd_project/databricks.yml](../first_cicd_project/databricks.yml) file.
...
Follow the instructions in [first_cicd_project/resources/README.md](../first_cicd_project/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../first_cicd_project/resources/README.md)  to propose, test, and deploy
