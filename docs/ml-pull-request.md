...
Opening a pull request will trigger a[workflow](../.github/workflows/first_cicd_project-run-tests.yml) 
...
Links:
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/first_cicd_project/first_cicd_project-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/first_cicd_project/first_cicd_project-model)
. 
